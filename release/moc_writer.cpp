...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Writer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Writer_t qt_meta_stringdata_Writer = {
    {
QT_MOC_LITERAL(0, 0, 6), // "Writer"
QT_MOC_LITERAL(1, 7, 19), // "filesWrittenChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "nbFiles"

    },
    "Writer\0filesWrittenChanged\0\0nbFiles"
};
...
void Writer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Writer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Writer::filesWrittenChanged)) {
                *result = 0;
            }
        }
    }
...
void *Writer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Writer.stringdata))
...
// SIGNAL 0
void Writer::filesWrittenChanged(int _t1)
{
